...
class RailFenceApp(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("RAILFENCE CIPHER - Nguyen Chi Tam (MSSV: 2380601979)")
    ...
    def call_api_encrypt(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Cảnh báo", "Key của Rail Fence phải là số nguyên lớn hơn hoặc bằng 2!")
            return
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.information(self, "Thành công", "RailFence Encrypted successfully")
            else:
    ...
    def call_api_decrypt(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                QMessageBox.information(self, "Thành công", "RailFence Decrypted successfully")
            else:
                print(f"Error while calling API: Status code {response.status_code}")
        except requests.exceptions.RequestException as e:
            print(f"Error: {str(e)}")
